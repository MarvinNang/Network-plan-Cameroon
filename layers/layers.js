...
lyr_GoogleSatellite_0.setVisible(true);lyr_cameroonnewscores_1.setVisible(true);lyr_boundariesadmindepartment_2.setVisible(true);lyr_Active_sites_NP_16062026_3.setVisible(true);lyr_Identified_sites_NP_16062026_4.setVisible(true);lyr_Planned_sites_NP_16062026_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_cameroonnewscores_1,lyr_boundariesadmindepartment_2,lyr_Active_sites_NP_16062026_3,lyr_Identified_sites_NP_16062026_4,lyr_Planned_sites_NP_16062026_5];
...
lyr_Identified_sites_NP_16062026_4.set('fieldAliases', {'Station_ID': 'Station_ID', 'City': 'City', 'Cluster': 'Cluster', 'Station Na': 'Station Na', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Status': 'Status', 'Comments': 'Comments', 'id': 'id', 'Station id': 'Station id', 'Name': 'Name', 'Department': 'Department', 'Region': 'Region', 'Floor_surf': 'Floor_surf', 'Roof_surf': 'Roof_surf', 'Type': 'Type', 'Racks Cap': 'Racks Cap', 'layer': 'layer', 'path': 'path', });
lyr_Planned_sites_NP_16062026_5.set('fieldAliases', {'Station_ID': 'Station_ID', 'City': 'City', 'Cluster': 'Cluster', 'Station Na': 'Station Na', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Status': 'Status', 'Comments': 'Comments', 'id': 'id', 'Station id': 'Station id', 'Name': 'Name', 'Department': 'Department', 'Region': 'Region', 'Floor_surf': 'Floor_surf', 'Roof_surf': 'Roof_surf', 'Type': 'Type', 'Racks Cap': 'Racks Cap', 'layer': 'layer', 'path': 'path', });
...
lyr_Active_sites_NP_16062026_3.set('fieldLabels', {'Station_ID': 'inline label - always visible', 'City': 'inline label - always visible', 'Cluster': 'inline label - always visible', 'Station Na': 'inline label - always visible', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Status': 'inline label - always visible', 'Comments': 'header label - visible with data', });
lyr_Identified_sites_NP_16062026_4.set('fieldLabels', {'Station_ID': 'no label', 'City': 'no label', 'Cluster': 'no label', 'Station Na': 'inline label - always visible', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Status': 'no label', 'Comments': 'no label', 'id': 'no label', 'Station id': 'no label', 'Name': 'no label', 'Department': 'no label', 'Region': 'no label', 'Floor_surf': 'no label', 'Roof_surf': 'no label', 'Type': 'inline label - always visible', 'Racks Cap': 'no label', 'layer': 'no label', 'path': 'no label', });
lyr_Planned_sites_NP_16062026_5.set('fieldLabels', {'Station_ID': 'no label', 'City': 'no label', 'Cluster': 'no label', 'Station Na': 'inline label - always visible', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Status': 'no label', 'Comments': 'no label', 'id': 'no label', 'Station id': 'no label', 'Name': 'no label', 'Department': 'no label', 'Region': 'no label', 'Floor_surf': 'no label', 'Roof_surf': 'no label', 'Type': 'inline label - always visible', 'Racks Cap': 'no label', 'layer': 'no label', 'path': 'no label', });
lyr_Planned_sites_NP_16062026_5.on('precompose', function(evt) {
